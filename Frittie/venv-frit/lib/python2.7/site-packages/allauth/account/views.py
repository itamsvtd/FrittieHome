...
from forms import LoginForm, ResetPasswordKeyForm, CompleteSignupForm, ProfileSignupForm
from forms import ResetPasswordForm, SetPasswordForm, InitSignupForm
from utils import sync_user_email_addresses
from frittie.helper.common_helper import get_member_login_object, get_new_buzzes
...
def email(request, **kwargs):
    ...
    template_name = 'auth_template/page/email.html'
...
def password_change(request, **kwargs):
    ...
    template_name = 'auth_template/page/password_change.html'
...
def password_set(request, **kwargs):
    ...
    template_name = 'auth_template/page/password_set.html'
...
def password_reset_done(request, **kwargs):
    ...
    if member_login:
        return HttpResponseRedirect("/")
    template_name = 'auth_template/page/password_reset_done.html'
    return render_to_response(template_name,RequestContext(request,{}))
...
def logout(request, **kwargs):
    ...
    kwargs['template_name'] = kwargs.pop('template_name','auth_template/page/logout.html')
