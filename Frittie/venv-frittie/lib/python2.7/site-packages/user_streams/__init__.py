...
def add_stream_item(user_or_users, friend_content, user_content, user_exclude=None, created_at=None):
    """
    ...
    user_exclude = user_exclude or ''
    backend.add_stream_item(users, friend_content,user_content, user_exclude, created_at)
