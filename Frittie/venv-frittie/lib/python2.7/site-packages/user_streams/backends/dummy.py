...
class MemoryStorage(object):
    ...
    def add_stream_item(self, users, friend_content, user_content, created_at):
        stream_item = DummyStreamItem(friend_content, user_content, created_at)
        for user in users:
...
class DummyBackend(object):
    ...
    def add_stream_item(self, users, friend_content, user_content , created_at):
        storage.add_stream_item(users, friend_content,user_content, created_at)
